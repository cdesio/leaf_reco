...
class UNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_transpose6 = conv_transpose(512, 256, out_padding=1)
        self.conv_block_up6 = double_conv(512, 256)

        self.conv_transpose7 = conv_transpose(256, 128, out_padding=1)
        self.conv_block_up7 = double_conv(256, 128)

        self.conv_transpose8 = conv_transpose(128, 64, out_padding=0)
        self.conv_block_up8 = double_conv(128, 64)
