...
import tqdm
from .utils.data import ChannelsFirst, ToTensor, Rescale, splitter
...
model_name = "model/trained_rUNet_regression_validation_{}epochs_coeff_mask{}_batch{}_on_npz.pkl".format(epochs,
                                                                                                         coeff_mask,
                                                                                                         batch_size)
